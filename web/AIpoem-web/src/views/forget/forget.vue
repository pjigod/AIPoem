    ...
    <div class="form-container">
      ...
      <form class="form">
        ...
        <div class="input-group">
          ...
          <input type="text" name="code" id="code" placeholder="输入邮箱验证码" v-model="code"><button id="count"
            @click="getCode" type="button">获取验证码</button>
        </div>
  ...
  methods: {
    ...
    getCode() {
      ...
      get('/user/forget/send', {
        ...
        button.textContent = "验证码已发送 (60s)";
        var count = 60;
        var countdown = setInterval(function () {
          count--;
          button.textContent = "验证码已发送 (" + count + "s)";
          if (count <= 0) {

    ...
    <div class="form-container">
      ...
      <form class="form">
        ...
        <div class="input-group">
          ...
          <div class="forgot">
            <a herf style="cursor: pointer;" @click="navTo('/forget')">忘记密码？</a>
          </div>
        </div>
        <button class="sign" @click="login" type="button">登录</button>
      </form>
      <div class="social-message">
        <div class="line"></div>
        <p class="message">用其他社交账号登录</p>
        <div class="line"></div>
      </div>
      ...
      <p class="signup">没有账号?
        <a href @click="navTo('/register')">注册</a>
      </p>
    </div>
  </div>
</template>
